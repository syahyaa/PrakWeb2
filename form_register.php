...
<body>
    <div class="container">
        <h3 style="text-align: center;">Form Register Data Science</h3>
        <form method="POST" action="form_register.php">
            ...
            <div class="form-group row">
                <label for="study" class="col-4 col-form-label">Program Study</label> 
                <div class="col-8">
...
//gunakan fingsi isset untuk memeriksa apakah suatu variable sudah di atur atau belum 
//jika ada variable yang bernilai NULL maka fungsi isset akan mengambilkan nialai FALSE
